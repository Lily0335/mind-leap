  ...
  const navLinks = (
    <ul className="font-medium flex flex-col md:flex-row lg:space-x-8 sm:space-x-4 space-y-2 md:space-y-0 p-4 md:p-0">
      <li>
        <motion.a
          href="#home"
          className={`text-white ${activeSection === 'home' ? 'isactive' : ''} hover:text-primary hover:scale-105 transition-all duration-200`}
      ...
      <li>
        <motion.a
          href="#services"
          className={`text-white ${activeSection === 'services' ? 'isactive' : ''} hover:text-primary hover:scale-105 transition-all duration-200`}
      ...
      <li>
        <motion.a
          href="#about"
          className={`text-white ${activeSection === 'about' ? 'isactive' : ''} hover:text-primary hover:scale-105 transition-all duration-200`}
      ...
      <li>
        <motion.a
          href="#pricing"
          className={`text-white ${activeSection === 'pricing' ? 'isactive' : ''} hover:text-primary hover:scale-105 transition-all duration-200`}
      ...
      <li>
        <motion.a
          href="#testimonial"
          className={`text-white ${activeSection === 'testimonial' ? 'isactive' : ''} hover:text-primary hover:scale-105 transition-all duration-200`}
